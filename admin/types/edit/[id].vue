<template>
  <form @submit.prevent="submitForm">
    <div>
      ...
      <div v-if="data">
        <div v-for="j in data" :key="j.id" class="j-details">
          <label for="type">Type:</label>
          <input v-model="j.type" id="type" type="text" class="form-field">

          <label for="scoreRangeStart">Range Start:</label>
          <input v-model="j.scoreRangeStart" id="scoreRangeStart" type="number" class="form-field">

          <label for="scoreRangeEnd">Range End:</label>
          <input v-model="j.scoreRangeEnd" id="scoreRangeEnd" type="number" class="form-field">

          <label for="message">Message:</label>
          <input v-model="j.message" id="message" type="text" class="form-field">
