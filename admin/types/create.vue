<template>
    <div>
      ...
      <form @submit.prevent="submitForm" class="simple-form">
        ...
        <label for="last_name">Range Start:</label>
        <input type="number" id="last_name" v-model="formData.last_name" class="form-field">
        <span class="error" v-if="formErrors.last_name">{{ formErrors.last_name }}</span>
  
        <label for="age">Range End:</label>
        <input type="number" id="age" v-model="formData.age" class="form-field">
